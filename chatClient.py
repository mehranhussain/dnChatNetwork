            ...
            if sock == s:
                ...
                # If FAIL
                    ...
                    if authResponse[2] == "PASSWORD":
                        print authResponse[0] + " " + authResponse[1] + " " + authResponse[3] + ": The password is not acceptable for authentication on this server."
                    elif authResponse[2] == "NAME":
                        print authResponse[0] + " " + authResponse[1] + " " + authResponse[3] + ": The specified name is already in use by another client."
                    elif authResponse[2] == "NUMBER":
                        print authResponse[0] + " " + authResponse[1] + " " + authResponse[3] + ": A number is not valid, either because it has already been used for another entity in case it was newly generated by the client, or there is no relevant entity that the number refers to."
                    elif authResponse[2] == "NAME":
                        print authResponse[0] + " " + authResponse[1] + " " + authResponse[3] + ": The chat message text is too long."
                    elif authResponse[2] == commands[5]:
                        print authResponse[0] + " " + authResponse[1] + " " + authResponse[3] + ": A malformed message or a message that is not valid in the current state of the client."
                        s.close()
